...
CacheSizeSamples = [100:200:1100 1300:300:1900 2000];
...
plot(CacheSizeSamples,(OtherHitCounter(2,:) +SelfHitCounter(2,:))./TotalRequests(2,:),'+');

plot(CacheSizeSamples,(SelfHitCounter(1,:))./TotalRequests(1,:),'xr'); hold on;
plot(CacheSizeSamples,(SelfHitCounter(2,:))./TotalRequests(2,:),'+r');

plot(CacheSizeSamples,(OtherHitCounter(1,:) ./TotalRequests(1,:)),'xk'); hold on;
plot(CacheSizeSamples,(OtherHitCounter(2,:) ./TotalRequests(2,:)),'+k');
...
plot(C,Phit + Phit2);
plot(C,Phit,'r'); hold on;
plot(C,Phit2,'k');

%%


plot(C,Phit + Phit2);hold on;
...
plot(CacheSizeSamples/CatalogSize,lch1Vec,'.');
plot(CacheSizeSamples/CatalogSize,lch2Vec,'.');


plot(CacheSizeSamples/CatalogSize,och1Vec,'+r');
plot(CacheSizeSamples/CatalogSize,och2Vec,'+r');


plot(CacheSizeSamples/CatalogSize,mshVec1,'xk');
plot(CacheSizeSamples/CatalogSize,mshVec2,'xk');
...
load stats_interacting_caches
grid on
xlabel('Cache size; Catalog size = 1000');
ylabel('Hit probability');
legend ('Total theory','Total hit-rate simulation (cache 1)', 'Total hit-rate simulation (cache 2)','Local theory','Local hit-rate simulation (cache 1)', 'Local hit-rate simulation (cache 2)');
title('Simulation of two interacting caches under BS control')
