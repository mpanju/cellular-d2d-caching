classdef LR_Cache < handle
   ...
   properties %(SetAccess = private)
    ...
    methods
        ...
        function cache = LR_Cache(cacheSize,catalogSize,ttlT)
            if (nargin > 0)
        ...
        function hit = emulate(this,CID,time)
            ...
            if length(probe) <= 1
                if isempty(probe) == 1 % Data not found in the cache.
                    expired = find( this.timeArrival < (time - this.ttlThreshold));
                    expired = 1:this.catalogSize;
